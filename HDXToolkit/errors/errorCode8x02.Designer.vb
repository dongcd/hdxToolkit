...
Partial Class errorCode8x02
    ...
    Private Sub InitializeComponent()
        ...
        Me.errorDetailLabel.TabIndex = 29
    ...
    "."
        ...
        Me.errorCodeLabel.TabIndex = 28
        Me.errorCodeLabel.Text = "Error 8×02"
        '
        'errorCode8x02
        '
