...
Partial Class errorCode7x02
    ...
    Private Sub InitializeComponent()
        ...
        Me.errorDetailLabel.TabIndex = 26
    ...
    "."
        ...
        Me.errorCodeLabel.TabIndex = 25
        Me.errorCodeLabel.Text = "Error 7×02"
        '
        'errorCode7x02
        '
