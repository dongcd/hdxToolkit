...
Partial Class errorCode9x02
    ...
    Private Sub InitializeComponent()
        ...
        Me.errorDetailLabel.TabIndex = 23
    ...
    "."
        ...
        Me.errorCodeLabel.TabIndex = 22
        Me.errorCodeLabel.Text = "Error 9×02"
        '
        'errorCode9x02
        '
