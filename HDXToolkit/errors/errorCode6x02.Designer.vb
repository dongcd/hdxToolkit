...
Partial Class errorCode6x02
    ...
    Private Sub InitializeComponent()
        ...
        Me.errorDetailLabel.TabIndex = 20
    ...
    "."
        ...
        Me.errorCodeLabel.TabIndex = 19
        Me.errorCodeLabel.Text = "Error 6×02"
        '
        'errorCode6x02
        '
